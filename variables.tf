...
variable "sku" {
  type        = string
  description = "(Optional) Specifies the SKU of the Log Analytics Workspace. PerGB2018 and CapacityReservation are recommended. Other possible values are PerNode, Standalone, and Unlimited. Defaults to PerGB2018. Free, Premium, and Standard do not work as per testing."
  default     = null
  validation {
